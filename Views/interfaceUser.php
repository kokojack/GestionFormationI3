...
<body>
	...
	<div id="libelle">
		<div class="scroll" class="intitule">
			...
			<br>
			<br> <a href="index.php?page=Controllers/disclaimer.php">
				<button>
					<i><b>Deconnexion</b></i>
				</button>
			</a>
...
<div class="intitule">
			...
			<button>
				<form action="#" method="POST">
					<input type="submit" name="chooseTraining"
						value="Choisir une formation">
				</form>
			</button>
			</a>
		</div>
	...
	<div class="intitule">
			<form action="#" method="POST">
				...
				<br> <input type="email" name="mail"
					placeHolder="nouvel.Admin@M2L.com" required> <br>
				<br> <input type="submit" name="givePower" value="NewAdmin">
			</form>
		<?php
